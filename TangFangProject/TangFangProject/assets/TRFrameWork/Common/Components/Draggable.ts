...
export default class Draggable extends cc.Component {
    ...
    private _dragEndCallback: Function = null;
    private _draggingCallback: Function = null;
    private _dragStartCallback: Function = null;


    public stopDrag: boolean = false;
    ...
    public setDragEndCallback(callback: Function) {
        this._dragEndCallback = callback;
    }

    public setDraggingCallback(callback: Function) {
        this._draggingCallback = callback;
    }

    public setDragStartCallback(callback: Function) {
    ...
    protected onDragStart() {
        this._dragStartCallback && this._dragStartCallback();
    }
    ...
    protected onDragMove() {
        this._draggingCallback && this._draggingCallback();
    }
     ...
     */
    protected onDragEnd() {
        this._dragEndCallback && this._dragEndCallback();
    }
