...
export default class DataBoard extends cc.Component {
    ...
    @property
    private _ancharColor: cc.Color = new cc.Color(255, 0, 0);
    @property({ displayName: CC_DEV && '······anchaar 颜色' })
    private get ancharColor() { return this._ancharColor };
    private set ancharColor(value: cc.Color) {
        this._ancharColor = value;
        this.anchorPointNode.color = value;
    }
    ...
    protected start() {
        ...
        this.anchorPointNode.color = this.ancharColor;
