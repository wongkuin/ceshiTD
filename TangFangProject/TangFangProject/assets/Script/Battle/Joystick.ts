 ...
 * 全局事件监听实例
 */
export const Joystick_ins = new cc.EventTarget();
...
export default class Joystick extends cc.Component {
   ...
   */
  onEnable() {
    Joystick_ins.on("set_joystick_type", this._onSetJoystickType, this);
  }
   ...
   */
  onDisable() {
    Joystick_ins.off("set_joystick_type", this._onSetJoystickType, this);
  }
  ...
  _touchStartEvent(event: cc.Event.EventTouch) {
    Joystick_ins.emit(cc.Node.EventType.TOUCH_START, event);
  ...
  _touchMoveEvent(event: cc.Event.EventTouch) {
    ...
    // console.log("speedType", speedType, p);
    Joystick_ins.emit(cc.Node.EventType.TOUCH_MOVE, event, {
      speedType: speedType,
      moveDistance: p,
    });
  }
  ...
  _touchEndEvent(event: cc.Event.EventTouch) {
    ...
    Joystick_ins.emit(cc.Node.EventType.TOUCH_END, event, {
